...
* **data/HILIC_POS_male/0_sample_metadata.csv** - sample metadata
* **data/HILIC_POS_male/0_feature_metadata.csv** - feature metadata
* **data/HILIC_POS_male/0_sample_metadata_filtered.csv** - sample metadata (with blank removed)
...
* **data/ctdf_f2000.csv** - example control vs treated dataframe for feature number 2000
* **data/ttest_ts2.csv** - t-test results for test substance 2 (both dose treatments)
* **data/combined_male_tstats.csv** - all t-stats for all test substances and treatements for males
* **data/unblinded_ordered_names.csv** - unblinded names of the test substances
* **data/cefic_matching_compounds.csv** - details of the test substances
