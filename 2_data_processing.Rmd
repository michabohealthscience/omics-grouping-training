...
hilic_pos_f <- read.csv(file.path(root, 'data/HILIC_POS_male/2_filtered.csv'), row.names = 1)
```
...
print(c('All samples:', samp_c_all))
print(c('Samples removed:', samp_c_all-samp_c_f))
print(c('Remaining samples:', samp_c_f))

print(c('All features:', feature_c_all))
print(c('Features removed:', feature_c_all-feature_c_f))
print(c('remaining features:', feature_c_f))
```
